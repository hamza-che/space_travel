const Typography = () => {
  return (
    <section className="flow" style={{ margin: "4rem 0" }}>
      ...
      <div className="flex">
        ...
        >
          ...
          <div>
            ...
            <p className="fs-700 ff-sans-cond uppercase">Jupiter & Saturn</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-light fs-500 ff-sans-cond uppercase letter-spacing-1">
